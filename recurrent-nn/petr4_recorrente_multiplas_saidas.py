...
plt.plot(preco_real_open, color = 'red', label = "Preço de abertura real")
plt.plot(previsoes[:,0], color = 'blue', label = "Previsão de abertura" )
...
plt.plot(preco_real_high, color = 'black', label = "Preço de alta real")
plt.plot(previsoes[:,1], color = 'orange', label = "Previsão de alta" )
plt.title("Previsão de preço das ações")
plt.xlabel("Tempo")
plt.ylabel("Valor Yahoo")
plt.legend()
