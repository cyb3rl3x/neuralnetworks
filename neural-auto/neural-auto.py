...
#Load dataset
base = pd.read_csv('C:/Users/Lex/jupyter-ds/neural-auto/autos.csv', encoding = 'ISO-8859-1')
...
regressor = KerasRegressor(build_fn = criar_rede, epochs = 100, batch_size = 100)
